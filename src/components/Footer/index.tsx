 ...
 * @LastEditTime: 2026-07-07 18:33:11
 * @Description: 底部版权
 */
...
const Footer: FC = () => {
  return (
    <footer className="mx-auto w-full container max-w-7xl px-6 py-4 grid grid-cols-1 sm:grid-cols-3 items-center gap-2" id="footer">
